...
1. vytvoření přehledu odvětví a vývoje cen v jednotlivých letech
...
2. pro posouzení rychlosti nárůstu jsem se rozhodnou porovnat pouze rok 2006 a 2018 a vybrat položky,které zdražovaly nejpomaleji
...
b. vnořený SELECT spojí výsledky cen za rok 2006 a 2018, vypočítá rozdíl a porovná s rokem 2006 a vypočítá procentní nárůst
...
ORDER BY 
   narust_procenta ASC;
    ...
    Výslekdem je pokles cen u krystalového curku, rajských jablke a nejmenší nárůst mezi roky 2006 a 2018 je u banánů žlutých
